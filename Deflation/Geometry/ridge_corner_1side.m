function [output, square_deg] = ridge_corner_1side(eps_vec, d, ref)

% RIDGE_CORNER_1SIDE: Single sided "corner-cut" configuration.
% INPUT:
...
for k = 1:length(eps_vec)
    ...
    A = [0.1875, 0]; B = [0.1875, 0.5]; C=[0.5 0.5];
    D = [0.5, 0.75+eps]; E = [0.8125, 0.5]; F = [0.8125, 0];
