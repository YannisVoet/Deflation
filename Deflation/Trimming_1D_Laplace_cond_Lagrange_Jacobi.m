...
% Conditioning of the Jacobi preconditioned matrices for the Lagrange basis.
...
problem_data.stabilize_flag = false;
problem_data.theta = 1;
problem_data.stabilization_type = 'physical'; % 'parametric'
