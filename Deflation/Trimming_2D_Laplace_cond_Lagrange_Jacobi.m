...
% Lagrange bases and various trimming configurations.
...
for j = 1:length(drange)
    ...
    for i = 1:ne
        ...
        % For C^0 spline discretizations, the Greville points coincide with
        % uniformly spaced interpolation points.
        [B,C]=interpbasis(sp_trimmed.space_untrimmed, interp_pts='greville', trunc=false);
